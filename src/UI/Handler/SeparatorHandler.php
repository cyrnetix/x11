...
use Cyrnetix\X11\UI\Painter\SeparatorPainter;
use Cyrnetix\X11\UI\Widget\Separator;
use Cyrnetix\X11\UI\Widget\Widget;

/** Display-only: a separator has nothing to interact with. */
final class SeparatorHandler extends WidgetHandler
{
    /** Takes what it needs to find, paint and repaint its own kind of widget. */
    public function __construct(private readonly SeparatorPainter $painter) {}
    ...
    {
        if (!$w instanceof Separator) return false;
